...
export default function ScrollTop() {
  ...
  return (
    <button
      ...
      className="group fixed bottom-8 right-8 z-40 flex h-12 w-12 items-center justify-center rounded-full border transition-all duration-[400ms] hover:scale-[1.08] hover:border-[var(--accent-brand)]"
      style={{
