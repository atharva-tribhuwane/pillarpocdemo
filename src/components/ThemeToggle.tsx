...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      data-cursor="hover"
      onClick={() => toggleTheme()}
      className="group fixed bottom-[92px] right-8 z-40 flex h-12 w-12 items-center justify-center rounded-full border transition-all duration-[200ms] hover:scale-[1.08] hover:border-[var(--accent-brand)]"
      style={{
